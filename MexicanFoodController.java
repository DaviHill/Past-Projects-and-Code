...
public class MexicanFoodController {
    ...
    void Appetizers1Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Appetizers", "Jalapeño Poppers", "", 5.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Appetizers2Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Appetizers", "Guacamole Dip", "", 5.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Appetizers3Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Appetizers", "Queso Dip", "", 5.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Appetizers4Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Appetizers", "Nachos", "", 5.99, 1, "None");
        AddItem(new_menu_item);
    }
    ...
    void Beverages3Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Beverages", "Horchata", "", 3.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Beverages4Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Beverages", "Margarita", "", 3.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Desserts1Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Desserts", "Tres Leches Cake", "", 10.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Desserts2Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Desserts", "Churros", "", 10.99, 1, "None");
        AddItem(new_menu_item);
    ...
    void Desserts3Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Desserts", "Caramel Flan", "", 10.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Desserts4Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Desserts", "Sopapillas", "", 10.99, 1, "None");
        AddItem(new_menu_item);
    ...
    void Entres1Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Entres", "Burrito", "", 15.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Entres2Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Entres", "Quesadilla", "", 15.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Entres3Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Entres", "Taco", "", 15.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Entres4Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Entres", "Tortilla Soup", "", 15.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Kids1Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Kid's", "Kid's Taco", "", 10.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Kids2Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Kid's", "Kid's Burrito", "", 10.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Kids3Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Kid's", "Kid's Quesadilla", "", 10.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Kids4Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Kid's", "Kid's Nachos", "", 10.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Sides1Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Sides", "Rice", "", 5.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Sides2Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Sides", "Black Beans", "", 5.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Sides3Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Sides", "Refried Beans", "", 5.99, 1, "None");
        AddItem(new_menu_item);
    }

    @FXML
    void Sides4Pressed(ActionEvent event) {
        MenuItem new_menu_item = new MenuItem("Sides", "Street Corn", "", 5.99, 1, "None");
        AddItem(new_menu_item);
    }
